...
export const MOCK_REQUESTS: DeliveryRequest[] = [
  {
    ...
    dailySlots: { '2026-06-28': { inbound: 3, outbound: 2, twoWay: 1 } },
  ...
  },
  {
    ...
    dailySlots: { '2026-06-29': { inbound: 0, outbound: 4, twoWay: 0 } },
  ...
  },
  {
    ...
    dailySlots: { '2026-07-05': { inbound: 2, outbound: 1, twoWay: 0 } },
    vehicleType: 'HGV_ACA_MDS', driverRoute: 'route2a',
