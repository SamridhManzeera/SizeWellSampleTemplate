...
function LoginV2() {
  ...
  return (
    <main className="lv2-page">
      <section className="lv2-visual" aria-label="Sizewell C visual">
        <video
          className="lv2-video"
          src={HERO_VIDEO}
          autoPlay
          ...
          playsInline
        />
        <div className="lv2-video-overlay" />

        <button
          type="button"
          className="lv2-back-btn"
          onClick={() => navigate(-1)}
          aria-label="Go back"
        >
        ...
        <div className="lv2-visual-brand">
          <img src={brandLogo} alt="Sizewell C" />
          <p>Forecasting Portal</p>
        </div>
      </section>

      <section className="lv2-form-panel">
        <form className="lv2-card" onSubmit={e => e.preventDefault()}>
          ...
          <h1>Welcome Back</h1>
          <p className="lv2-subtitle">Sign in to access the Sizewell C Forecasting Portal.</p>

          <div className="lv2-field-group">
            <div className="lv2-field-row">
              <label htmlFor="lv2-email">Email or Username</label>
            </div>
            <div className="lv2-input-box">
          ...
          <label className="lv2-options" htmlFor="lv2-remember">
            <input id="lv2-remember" name="remember" type="checkbox" />
            Keep me logged in
          </label>

          <button className="lv2-submit" type="submit">
            <span className="lv2-btn-content">
          ...
          <div className="lv2-secure">
            <div className="lv2-secure-line">Secure access</div>
